<?php
class ControllerProductotquickview extends Controller
{
    public function index() {
        ...
        if(!$json) {
            if($data) {
                $json['html'] = $this->load->view('product/ot_quickview/product', $data);
                $json['success'] = true;
            } else {
                $json['success'] = false;
    ...
    public function seoview() {
        ...
        $this->load->model('catalog/ot_quickview');

        if(!$json) {
            if (isset($this->request->get['ourl'])) {
                $seo_url = $this->request->get['ourl'];

                $product_id = $this->model_catalog_ot_quickview->getProductBySeoUrl($seo_url);
    ...
    public function container() {
		$this->load->language('product/ot_quickview');
		
        $data['ot_quickview_loader_img'] = $this->config->get('config_url') . 'image/catalog/AjaxLoader.gif';
        

        return $this->load->view('product/ot_quickview/ot_qvcontainer', $data);
    }
