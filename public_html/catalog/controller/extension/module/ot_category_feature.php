...
class ControllerExtensionModuleOTCategoryFeature extends Controller {
	...
	return $this->load->view('extension/module/ot_category_feature', $data);
		/*if ($data['categories']) {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/module/ot_category_feature.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/extension/module/ot_category_feature.tpl', $data);
			} else {
				return $this->load->view('default/template/extension/module/ot_category_feature.tpl', $data);
			}
		}*/
	}
}